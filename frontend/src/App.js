...
import MeditationTracker from './compnents/meditation/MeditationTracker.jsx';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/:username/meditation" element={<PrivateRoute><MeditationTracker /></PrivateRoute>} />
